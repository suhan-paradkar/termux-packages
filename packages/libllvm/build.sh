...
termux_step_post_make_install() {
	if [ $TERMUX_ARCH = "arm" ]; then
		cp $TERMUX_PKG_SRCDIR/openmp/runtime/exports/common/include/omp.h $TERMUX_PKG_MASSAGEDIR$TERMUX_PREFIX/include
	else
		cp $TERMUX_PKG_SRCDIR/openmp/runtime/exports/common.ompt.optional/include/omp.h $TERMUX_PKG_MASSAGEDIR$TERMUX_PREFIX/include
	fi
	...
	cp tools/lldb/docs/man/lldb.1 $TERMUX_PKG_MASSAGEDIR$TERMUX_PREFIX/share/man/man1
